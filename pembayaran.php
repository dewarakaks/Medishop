...
//pembayaran berdasarkan id_pembelian
$idPembeli = $_GET["id"];

$ambil =$koneksi->query("SELECT * FROM pembelian WHERE id_pembelian='$idPembeli'");

$totalPembelian= $ambil->fetch_assoc();




//mendapatkan id_pelanggan yang beli
$id_pelanggan_beli = $totalPembelian["id_pelanggan"];

//mendapatkan id_pelanggan dari pelanggan yg login
...
<body>
	...
	<div class="container" style="margin-top: 10%;">
		...
		<p>Kirim bukti</p>
		<div class="alert alert-info">total tagihan anda <strong>Rp. <?php echo number_format($totalPembelian["total_pembelian"]) ?></strong></div>
	...
	if (isset($_POST["kirim"])) 
	{
		...
		$koneksi->query("INSERT INTO pembayaran(id_pembelian, nama, bank, jumlah, tanggal, bukti)
			VALUES ('$idPembeli','$nama', '$bank', '$jumlah', '$tanggal', '$namafix')");
